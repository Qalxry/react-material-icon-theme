...
import { IconCard, IconInfo } from './IconCard';
    ...
    return (
      <div className="icon-grid-loading">
        <div className="loading-spinner">
          <img 
            src="https://unpkg.com/lucide-static@0.540.0/icons/loader-2.svg"
            alt="Loading"
            className="spinner"
          />
        </div>
  ...
  if (filteredIcons.length === 0) {
    return (
      <div className="icon-grid-empty">
        <img 
          src="https://unpkg.com/lucide-static@0.540.0/icons/search-x.svg"
          alt="No results"
